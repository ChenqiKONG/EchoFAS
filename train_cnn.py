...
from utils.dataloader_cnn import Intra_echo_datareader, my_transforms
...
def parse_args():
    ...
    parser.add_argument('--save_root', default='./Training_results/Cross/Cross_5id/cnn/', type=str)
...
def train(args, model):
    ...
    train_dataset = Intra_echo_datareader(csv_file=args.train_csv, transform=my_transforms())
    ...
    val_dataset = Intra_echo_datareader(csv_file=args.val_csv, transform=my_transforms())
    ...
    test_dataset1 = Intra_echo_datareader(csv_file=args.test_csv1, transform=my_transforms())
    ...
    test_dataset2 = Intra_echo_datareader(csv_file=args.test_csv2, transform=my_transforms())
    ...
    test_dataset3 = Intra_echo_datareader(csv_file=args.test_csv3, transform=my_transforms())
    ...
    test_dataset4 = Intra_echo_datareader(csv_file=args.test_csv4, transform=my_transforms())
    ...
    test_dataset5 = Intra_echo_datareader(csv_file=args.test_csv5, transform=my_transforms())

...
class Transformer_freq(nn.Module):
    def __init__(self, *, num_patches, patch_dim, dim, depth, heads, mlp_dim, pool='cls', dim_head=32, dropout=0.,
                 emb_dropout=0.):
        super().__init__()
    ...
    def forward(self, signal):
        ...
        self.pos_embedding = torch.cat(
            (self.pos_embedding1, self.pos_embedding2, self.pos_embedding3, self.pos_embedding4), dim=1)
